...
public class QueryCaseInfoController { 
	...
	@ResponseBody
	public Map<String, Object> getExportCaseInfoTable(HttpSession session,HttpServletRequest request,HttpServletResponse response ,String qtype,String etype) throws Exception{
