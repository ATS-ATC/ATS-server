    ...
    <div class="panel-body">
    	<div id="toolbar" style="text-align:left;">
    		...
    		<shiro:hasPermission name="lab:create">
	    		<a class="btn btn-info btn-sm" type="button" href="#" id="add">
    		...
    		<a class="btn btn-default btn-sm" type="button" id="checkAddLog" href="./addlablog.do">
       				...
       				<div class="col-md-12">
       					<form class="form-horizontal" role="form">
							  ...
							  <div class="form-group">
							    ...
							    <label for="ainsflag" class="col-sm-2 control-label" style="text-align: left;" data-toggle="tooltip" data-placement="bottom" title="yes means complete reloading  /  no means only reload spa and rtdb" >reload platform<sup>[?]</sup></label>
							    <div class="col-sm-4">
							  ...
							  <div class="form-group">
							  	<label id="csset" for="sset" class="col-sm-2 control-label" style="text-align: left;" data-toggle="tooltip" data-placement="bottom" title="click to create / click to select" >set<sup>[?]</sup></label>
