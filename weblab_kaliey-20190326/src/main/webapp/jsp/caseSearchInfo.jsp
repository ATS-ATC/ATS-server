	        		...
	        		<tbody>
	        			<c:forEach items="${scase }" var="data" >
	        				...
	        				<tr>
	        					...
	        					<td style="background-color:#D9EDF7">${data.case_status }</td>
	        	...
	        	<table class="table table-bordered text-nowrap"  >
	        		<thead>
	        			<tr>
	        				...
	        				<th>spa</th>
	        				<th>db</th>
	        				<th>[server:check_spa:check_db]</th>
	        				<th>release</th>
	        				<th>author</th>
	        				<th>special_data</th>
	        				<th>lab_number</th>
	        		...
	        		<tbody>
	        			<c:forEach items="${fcase }" var="data" >
	        				...
	        				<tr>
	        					...
	        					<td>${data.spa }</td>
	        					<td>${data.db }</td>
	        					<td style="background-color:#D9EDF7">${data.case_server }</td>
	        					<td>${data.release }</td>
	        					<td>${data.author }</td>
	        					<td>${data.special_data }</td>
	        					<td>${data.lab_number }</td>
