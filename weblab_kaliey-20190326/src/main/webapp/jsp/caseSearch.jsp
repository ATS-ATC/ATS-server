            			...
            			<div class="row" style="margin-bottom: 10px;">
							<div class="col-md-4">
								<div style="margin-right: 13px;">
									<h5 style="display: inline;"><strong>Workable Release</strong></h5>
									<select class="selectpicker nav navbar-nav navbar-right" multiple data-live-search="true"  data-max-options="1">
									    <c:if test="${release!=null && fn:length(release) > 0}">
				        ...
				        <div class="modal-content">
				            ...
				            <div class="modal-body">
				                ...
				                <div id="importCase" class="row" style="display: none;">
				                	<div id="inputbox" >
					    				<p><input id="kv-explorer" type="file" name="file" class="file" /></p>
					    			</div>
					    			<div id="inputDiv" class="table-responsive" hidden style="height:298px;overflow:scroll">
